...
/// <summary>
/// The files `wireframe setup` writes into a new project. These are the first thing an
/// agent reads, so they double as documentation: the starter App.tsx demonstrates the
/// conventions (named-enum props, sizing values, the SketchProvider/.tendril wrappers)
/// that the component library expects.
/// </summary>
public static class ScaffoldTemplates
{
    ...
    public const string GitIgnoreBlock =
        """

        # Regenerated by `wireframe setup`; safe to delete.
        .wireframe/
